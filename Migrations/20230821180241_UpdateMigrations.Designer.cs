...
namespace BIS_project.Migrations
{
    ...
    [Migration("20230821180241_UpdateMigrations")]
            ...
            modelBuilder.Entity("BIS_project.Models.Order", b =>
                {
                    ...
                    b.Property<bool>("FlexibleLoad")
                        .HasColumnType("boolean");

                    b.Property<int>("FromDistrictId")
                        .HasColumnType("integer");

                    b.Property<DateOnly>("FromFlexibleDate")
                        .HasColumnType("date");

                    b.Property<int>("FromRegionId")
                        .HasColumnType("integer");

                    b.Property<DateOnly>("LoadDaytime")
                        .HasColumnType("date");
                    ...
                    b.Property<DateOnly>("ToFlexibleDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("BIS_project.Models.Order", b =>
                {
                    ...
                    b.HasOne("BIS_project.Models.Employee", "Employee")
                        .WithMany()
